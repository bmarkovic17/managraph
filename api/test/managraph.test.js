...
describe('ManaGraph', function () {
    describe('Active instance', function () {
        beforeEach(function () {
            managraph = new Managraph();
        });

        it('Should add new instance', function () {
            assert.doesNotReject(managraph.addMemgraph(instanceName, instanceUri));
        });

        it('Should return memgraph info object on add new instance', async function () {
    ...
    describe('Inactive instance', function () {
        beforeEach(function () {
            managraph = new Managraph();
        });

        it('Should add new instance', function () {
            assert.doesNotReject(managraph.addMemgraph(instanceNameReversed, instanceUriReversed));
        });
    ...
    describe('Invalid instance', function () {
        before(async function () {
            await new Managraph().addMemgraph(instanceName, instanceUri);
        });
    ...
    describe('Multiple instances', function () {
        ...
        before(async function () {
            ...
            managraph.addMemgraph(instanceName, instanceUri);
            managraph.addMemgraph(instanceNameReversed, instanceUriReversed);
        });
